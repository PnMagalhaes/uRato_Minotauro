...
//  1-Bridge control
	...
	LATDbits.LATD5 = OUT;		// STDBY
    LATGbits.LATG9 = OUT;  		// M1_IN1
    LATDbits.LATD7 = OUT; 		// M1_IN2
...
void readAnalogSensors(void)
{
	...
	// Ch 11 - Battery
	static int channels[]={0, 1, 2};	// Do not change order...
	int i;
	int adcValue;
...
{
	unsigned int t;
    t=ReadCoreTimer()+40000*tenth_ms;
